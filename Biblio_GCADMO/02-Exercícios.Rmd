...
As capacidades anuais de processamento das três plantas são de 9 × 10<sup><small>5</small></sup> tonelada,  7 × 10<sup><small>5</small></sup> toneladas e 3 × 10<sup><small>5</small></sup> toneladas de carvão, respectivamente.
...
É necessário produzir um total de 10<sup><small>6</small></sup> toneladas de coque metalúrgico ao final do ano.
...
<p class="small-text">a\) Determine o modelo de PI para o problema de contratação e alocação de frota da BRF.<br>
b\) Escreva o modelo genérico (conjuntos, parâmetros, variáveis) para o problema.</p>
